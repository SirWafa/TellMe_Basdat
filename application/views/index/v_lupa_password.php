...
<body class="layout-navbar-mini-fixed-bottom">
                ...
                <div data-primary class="navbar navbar-expand-sm navbar-dark bg-dark p-0" id="default-navbar">
                    <div class="container">
                        ...
                        <a href="index.html" class="navbar-brand">
                            <img class="navbar-brand-icon" src="<?php echo base_url('assets/tealdark/images/logo/white-100@2x.png')?>" width="30" alt="Tutorio">
                        ...
                        <ul class="nav navbar-nav ml-auto d-none d-sm-flex">
                            ...
                            <li class="nav-item active">
                                <a href="signup.html" class="nav-link">Lupa Password</a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="container page__container">
                    <div class="col-sm-6 mx-auto">
                        <div class="alert alert-light border-1 border-left-3 border-left-accent d-flex mb-24pt" role="alert">
                            ...
                            <div class="text-body">Tautan akan dikirimkan melalui email anda. Silahkan cek email anda untuk melanjutkan ke halaman reset password melalui tautan tersebut. Tautan berlaku 1x24 jam</div>
                        </div>
                        ...
                        <form action="change-password.html">
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">Pastikan email yang anda masukkan aktif!</small>
                            </div>
            ...
            <!-- <ul class="nav navbar-nav flex-nowrap">
                ...
                <li class="nav-item dropup active">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item active" href="reset-password.html">Reset Password</a>
    ...
    <div id="app-settings">
      ...
      'blue-light': 'http://tutorio-bootstrap.frontendmatter.com/reset-password.html',
      'blue-dark': 'http://tutorio-dark.frontendmatter.com/reset-password.html',
      'teal-light': 'http://tutorio-teal.frontendmatter.com/reset-password.html',
      'teal-dark': 'http://tutorio-teal-dark.frontendmatter.com/reset-password.html'
